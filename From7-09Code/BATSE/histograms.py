...
histogram(tablePeakDif,constitle,'Time Difference (> 25 keV) (s)','table')
histogram(thPeakDif,constitle,'Time Difference (> 25 keV) (s)','th')
histogram(nthPeakDif,constitle,'Time Difference (> 60 keV) (s)','nth')
histogram(smthPeakDif,constitle,'Time Difference (> 25 keV) (s)','smth')
histogram(smnthPeakDif,constitle,'Time Difference (> 60 keV) (s)','smnth')