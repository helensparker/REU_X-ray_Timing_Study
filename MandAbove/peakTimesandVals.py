...
for i in tqdm(range(index,index+distance)):
    ...
    for j in range(17,4,-1):
        ...
        if not type(goes) is list:
            ...
            maxtime54 = goesGetMaxandTime(arrgoes,0)
            deltatime54 = maxtime54[0]
            time54 = dsstart + timedelta(0,deltatime54)
            val54 = maxtime54[1]
            ...
            data.append([sstart,send,time18,val18,time54,val54,time410,val410,time1015,val1015,time1525,val1525,time2550,val2550,time5084,val5084])
            break


with open('peaktimesandVals.csv', 'w', newline='') as file :
