...
consTitle = 'Hard X-ray Integral Until Peaks & SXR Peak Values'
nconsTitle = 'Hard & Soft X-rays Peak Time Since Start of Flare Smoothed Curves'

twodHistogram(flareClass,peaks18,ints1015,peaks1015,consTitle,r'SXR Peak Value (1.0-8.0A) (Watts m$^{-2}$)','HXR Integral Until Peak (10-15keV) (counts s)','peaks18ints1015')
twodHistogram(flareClass,peaks18,ints2550,peaks2550,consTitle,r'SXR Peak Value (1.0-8.0A) (Watts m$^{-2}$)','HHXR Integral Until Peak (25-50keV) (counts s)','peaks18ints2550')
