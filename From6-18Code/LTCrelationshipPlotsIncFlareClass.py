...
def twodHistogram(flarelist,sxrlist,hxrlist,title,xlab,ylab,saveas):
    ...
    plt.hist2d(sxrlist, hxrlist, bins=100, range=None, density=False, weights=None, cmin=None, cmax=None, cmap=plt.cm.nipy_spectral,norm=LogNorm())
    plt.title(title)
    plt.xlabel(xlab)
    plt.ylabel(ylab)
    #plt.xscale('log')
...
twodHistogram(flareClass,difs18,difs410,consTitle,'SXR Time from Start of Flare (1.0-8.0A) (s)','HXR Time from Start of Flare (4-10keV) (s)','difs18difs410')
twodHistogram(flareClass,difs18,difs1015,consTitle,'SXR Time from Start of Flare (1.0-8.0A) (s)','HXR Time from Start of Flare (10-15keV) (s)','difs18difs1015')
twodHistogram(flareClass,difs18,difs1525,consTitle,'SXR Time from Start of Flare (1.0-8.0A) (s)','HXR Time from Start of Flare (15-25keV) (s)','difs18difs1525')
twodHistogram(flareClass,difs18,difs2550,consTitle,'SXR Time from Start of Flare (1.0-8.0A) (s)','HXR Time from Start of Flare (25-50keV) (s)','difs18difs2550')
twodHistogram(flareClass,difs18,difs5084,consTitle,'SXR Time from Start of Flare (1.0-8.0A) (s)','HXR Time from Start of Flare (50-84keV) (s)','difs18difs5084')
