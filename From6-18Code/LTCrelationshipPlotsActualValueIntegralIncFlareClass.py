...
def twodHistogram(flarelist,sxrlist,hxrlist,title,xlab,ylab,saveas):
    ...
    plt.yscale('log')
    plt.colorbar()
    plt.savefig(f'efancyLogLTC{saveas}.png')
    plt.clf()
'''
    ...
    #plt.yscale('log')
    plt.colorbar()
    plt.savefig(f'xlogLTCX{saveas}.png')
    plt.clf()
    ...
    #plt.yscale('log')
    plt.colorbar()
    plt.savefig(f'xlogLTCM{saveas}.png')
    plt.clf()
    ...
    plt.xscale('log')
    plt.colorbar()
    plt.savefig(f'xlogLTCC{saveas}.png')
    plt.clf()
    '''
...
twodHistogram(flareClass,vals18,int410,consTitle,'Peak Flux (1.0-8.0A) (Watts m$\\mathregular{^{-2}}$)','HXR 3 Minute Integral (4-10keV) (counts s)','vals18int410')
twodHistogram(flareClass,vals18,int1015,consTitle,'Peak Flux (1.0-8.0A) (Watts m$\\mathregular{^{-2}}$)','HXR 3 Minute Integral (10-15keV) (counts s)','vals18int1015')
twodHistogram(flareClass,vals18,int1525,consTitle,'Peak Flux (1.0-8.0A) (Watts m$\\mathregular{^{-2}}$)','HXR 3 Minute Integral (15-25keV) (counts s)','vals18int1525')
twodHistogram(flareClass,vals18,int2550,consTitle,'Peak Flux (1.0-8.0A) (Watts m$\\mathregular{^{-2}}$)','HXR 3 Minute Integral (25-50keV) (counts s)','vals18int2550')
twodHistogram(flareClass,vals18,int5084,consTitle,'Peak Flux (1.0-8.0A) (Watts m$\\mathregular{^{-2}}$)','HXR 3 Minute Integral (50-84keV) (counts s)','vals18int5084')
